#https://github.com/JongsooKeum/RetinaNet-tensorflow/blob/master/convert_pfp.py
...
# FIXME
SRC_IMG_DIR = '/home/olysavra/everguard/dataset/PennFudanPed/PennFudanPed/PNGImages/'
SRC_ANNO_DIR = '/home/olysavra/everguard/dataset/PennFudanPed/PennFudanPed/Annotation/'

# FIXME
DST_ROOT_DIR = '/home/olysavra/everguard/dataset/PennFudanPed/PennFudanPed/Annotation/converted/'
...
def main(verbose=False):
    ...
    for txt_fpath, anno_dict in zip(tqdm(txt_fpaths), anno_dicts):
        ...
        with open(osp.join(dst_anno_dir, '{}.json'.format(sample_name)), 'w') as f:
